...
public class ControladorVotar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (request.getParameter("partido")) {
                case "PP": {
                    String userDNI = (String) sesion.getAttribute("userDNI");
                    
                    conexion.setAutoCommit(false);
                    Operaciones.actualizarVotante(conexion, new Votante(userDNI));
                    Operaciones.aumentarVotos(conexion, new Partido(request.getParameter("partido")));
                    conexion.commit();
            ...
            try {
                ...
                out.println("<br><br><h2>ROLLBACK:</h2>" + ex1 + "<br><br>");
            }
        }
    }
